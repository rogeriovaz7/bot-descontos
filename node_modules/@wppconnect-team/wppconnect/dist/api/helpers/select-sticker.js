...
async function stickerSelect(_B, _t) {
    ...
    switch (_t) {
        case 0:
            _ins = await (0, sharp_1.default)(_B, { failOn: 'none' })
                .resize({ width: 512, height: 512 })
                .toBuffer();
            _w = (0, sharp_1.default)(_ins, { failOn: 'none' }).webp();
            break;
        case 1:
...
async function resizeImg(buff, size) {
    const _ins = await (0, sharp_1.default)(buff, { failOn: 'none' })
        .resize({ width: size.width, height: size.height })
        .toBuffer(), _w = (0, sharp_1.default)(_ins, { failOn: 'none' }).jpeg(), _webb64 = (await _w.toBuffer()).toString('base64');
    return _webb64;
}
