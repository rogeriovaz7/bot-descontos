...
class SenderLayer extends listener_layer_1.ListenerLayer {
    ...
    async sendImageFromBase64(to, base64, filename, caption, quotedMessageId, isViewOnce, mentionedList, options) {
        ...
        const sendResult = await (0, helpers_1.evaluateAndReturn)(this.page, async ({ to, base64, filename, caption, quotedMessageId, isViewOnce, mentionedList, options, }) => {
    ...
    async sendPttFromBase64(to, base64, filename, caption, quotedMessageId, messageId, isPtt = true) {
        const sendResult = await (0, helpers_1.evaluateAndReturn)(this.page, async ({ to, base64, filename, caption, quotedMessageId, messageId, isPtt, }) => {
            const result = await WPP.chat.sendFileMessage(to, base64, {
                type: 'audio',
                isPtt: isPtt,
                filename,
    ...
    async sendVideoAsGifFromBase64(to, base64, filename, caption, quotedMessageId) {
        const sendResult = await (0, helpers_1.evaluateAndReturn)(this.page, async ({ to, base64, filename, caption, quotedMessageId }) => {
            const result = await WPP.chat.sendFileMessage(to, base64, {
                type: 'video',
                isGif: true,
                filename,
    ...
    async sendImageAsStickerGif(to, pathOrBase64, options) {
        ...
        const sendResult = await (0, helpers_1.evaluateAndReturn)(this.page, async ({ to, webpBase64, options }) => {
    ...
    async sendLocation(to, latitudeOrOptions, longitude, title) {
        const options = typeof latitudeOrOptions === 'string'
            ...
            : latitudeOrOptions;
        const sendResult = await (0, helpers_1.evaluateAndReturn)(this.page, async ({ to, options }) => {
