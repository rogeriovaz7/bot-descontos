...
export type LinkDeviceEvent = 'link_device_events:error_alt_linking' | 'link_device_events:force_manual_refresh' | 'link_device_events:primary_hello_received' | 'link_device_events:refresh_alt_linking_code';
