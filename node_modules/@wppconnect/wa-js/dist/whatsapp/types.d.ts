 ...
 */
export type ChatSearchFilter = 'unread' | 'favorites' | 'group' | 'community' | 'broadcast' | 'contact' | 'non_contact' | 'assigned_to_you' | 'personal' | 'business' | 'labels' | 'channels' | 'ai_responding' | 'ai_handoff';
